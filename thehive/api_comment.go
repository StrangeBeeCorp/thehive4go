...
func (r ApiCreateCommentInAlertRequest) InputComment(inputComment InputComment) ApiCreateCommentInAlertRequest {
	r.inputComment = &inputComment
	return r
}

func (r ApiCreateCommentInAlertRequest) Execute() (*OutputComment, *http.Response, error) {
	return r.ApiService.CreateCommentInAlertExecute(r)
}
...
func (a *CommentAPIService) CreateCommentInAlertExecute(r ApiCreateCommentInAlertRequest) (*OutputComment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/alert/{alertId}/comment"
	...
	if r.inputComment == nil {
		return localVarReturnValue, nil, reportError("inputComment is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.inputComment
...
func (r ApiCreateCommentInCaseRequest) InputComment(inputComment InputComment) ApiCreateCommentInCaseRequest {
	r.inputComment = &inputComment
	return r
}

func (r ApiCreateCommentInCaseRequest) Execute() (*OutputComment, *http.Response, error) {
	return r.ApiService.CreateCommentInCaseExecute(r)
}
...
func (a *CommentAPIService) CreateCommentInCaseExecute(r ApiCreateCommentInCaseRequest) (*OutputComment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/case/{caseId}/comment"
...
func (a *CommentAPIService) DeleteCommentExecute(r ApiDeleteCommentRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/comment/{commentId}"
...
func (r ApiUpdateCommentRequest) InputComment(inputComment InputComment) ApiUpdateCommentRequest {
	r.inputComment = &inputComment
	return r
}
...
func (a *CommentAPIService) UpdateCommentExecute(r ApiUpdateCommentRequest) (*http.Response, error) {
	...
	localVarFormParams := url.Values{}
	if r.inputComment == nil {
		return nil, reportError("inputComment is required and must be specified")
	}
