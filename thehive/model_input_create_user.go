...
type InputCreateUser struct {
	...
	// Normal, Service or External. A service user cannot use the ui and needs to provide an api key for authentication. An external user only has access to the portal
