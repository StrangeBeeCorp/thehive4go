...
`func NewOutputAlertStatus(underscoreId string, underscoreType string, underscoreCreatedAt int32, underscoreCreatedBy string, value string, stage string, hidden bool, extraData map[string]interface{}, ) *OutputAlertStatus`
...
`func (o *OutputAlertStatus) SetUnderscoreUpdatedAt(v int32)`
...
`func (o *OutputAlertStatus) SetUnderscoreCreatedAt(v int32)`
