...
// checks if the BooleanPropertyDescription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BooleanPropertyDescription{}

// BooleanPropertyDescription struct for BooleanPropertyDescription
...
type _BooleanPropertyDescription BooleanPropertyDescription
...
func NewBooleanPropertyDescription(name string, cardinality Cardinality, aggregable bool, indexType BasicIndexType, type_ string) *BooleanPropertyDescription {
	this := BooleanPropertyDescription{}
	this.Name = name
...
func (o BooleanPropertyDescription) MarshalJSON() ([]byte, error) {
...
func (o BooleanPropertyDescription) ToMap() (map[string]interface{}, error) {
...
func (o *BooleanPropertyDescription) UnmarshalJSON(data []byte) (err error) {
	...
	varBooleanPropertyDescription := _BooleanPropertyDescription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBooleanPropertyDescription)

	if err != nil {
		return err
	}

	*o = BooleanPropertyDescription(varBooleanPropertyDescription)

	return err
}

type NullableBooleanPropertyDescription struct {
	value *BooleanPropertyDescription
	isSet bool
}

func (v NullableBooleanPropertyDescription) Get() *BooleanPropertyDescription {
	return v.value
}

func (v *NullableBooleanPropertyDescription) Set(val *BooleanPropertyDescription) {
	v.value = val
	v.isSet = true
}

func (v NullableBooleanPropertyDescription) IsSet() bool {
	return v.isSet
}

func (v *NullableBooleanPropertyDescription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBooleanPropertyDescription(val *BooleanPropertyDescription) *NullableBooleanPropertyDescription {
	return &NullableBooleanPropertyDescription{value: val, isSet: true}
}

func (v NullableBooleanPropertyDescription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBooleanPropertyDescription) UnmarshalJSON(src []byte) error {
	v.isSet = true
