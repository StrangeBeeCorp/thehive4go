...
type UserAccess struct {
	// Selected users' logins. Must contain at least the assignee of the case and the user making the request.
	Users []string `json:"users"`
	Kind  string   `json:"_kind"`
}

type _UserAccess UserAccess
...
func (o *UserAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varUserAccess := _UserAccess{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserAccess)

	if err != nil {
		return err
	}

	*o = UserAccess(varUserAccess)
